...
**Scenario**: You are a junior PAM administrator in a company deploying CyberArk PAM Self-Hosted. You need to provide browser-based access to privileged sessions while maintaining security (TLS, JWT validation). This lab simulates a standalone HTML5 Gateway deployment.
